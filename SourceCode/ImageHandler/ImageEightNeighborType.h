#ifndef __IMAGE_EIGHT_NEIGHBOR_TYPE_H_INCLUDED__
#define __IMAGE_EIGHT_NEIGHBOR_TYPE_H_INCLUDED__
...
class ImageEightNeighborType : public Image
{
public:
    ImageEightNeighborType(const vector<ushort>& pixels,
...
#endif // __IMAGE_EIGHT_NEIGHBOR_TYPE_H_INCLUDED__
