...
TEST(BidimiensionalArrayPartitioner, test18x7in6) {
    ...
    Tile expectedTile3 = { 54, 55, 56, 57, 58, 59,
                           72, 73, 74, 75, 76, 77,
                           90, 91, 92, 93, 94, 95,
                           108, 109, 110, 111, 112, 113 };

    Tile expectedTile4 = { 60, 61, 62, 63, 64, 65,
                           78, 79, 80, 81, 82, 83,
                           96, 97, 98, 99, 100, 101,
                           114, 115, 116, 117, 118, 119 };

    Tile expectedTile5 = { 66, 67, 68, 69, 70, 71,
                           84, 85, 86, 87, 88, 89,
                           102, 103, 104, 105, 106, 107,
                           120, 121, 122, 123, 124, 125 };
...
TEST(BidimiensionalArrayPartitioner, test7x18in6) {
    ...
    Tile expectedTile3 = { 45, 46, 47, 48,
                           52, 53, 54, 55,
                           59, 60, 61, 62,
                           66, 67, 68, 69,
                           73, 74, 75, 76,
    ...
    Tile expectedTile5 = { 87, 88, 89, 90,
                           94, 95, 96, 97,
                           101, 102, 103, 104,
                           108, 109, 110, 111,
                           115, 116, 117, 118,
...
TEST(BidimiensionalArrayPartitioner, test13x7in8) {
    ...
    Tile expectedTile2 = { 6, 7, 8,
                           19, 20, 21,
                           32, 33, 34 };

    Tile expectedTile3 = { 9, 10, 11, 12,
                           22, 23, 24, 25,
                           35, 36, 37, 38 };

    Tile expectedTile4 = { 39, 40, 41,
                           52, 53, 54,
                           65, 66, 67,
                           78, 79, 80 };

    Tile expectedTile5 = { 42, 43, 44,
                           55, 56, 57,
                           68, 69, 70,
                           81, 82, 83 };

    Tile expectedTile6 = { 45, 46, 47,
                           58, 59, 60,
                           71, 72, 73,
                           84, 85, 86 };

    Tile expectedTile7 = { 48, 49, 50, 51,
                           61, 62, 63, 64,
                           74, 75, 76, 77,
                           87, 88, 89, 90};
